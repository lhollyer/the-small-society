...
<Container>
    ...
    <p>
        In the end, Pete had built himself a house during the renovation (The Outside
        House), but he had also got side-tracked and accidentally added two more separate, living
        spaces - which ultimately meant he had room to spare.
    </p>

    <div>
        <h2>The Space in Deal</h2>
        <p>
            It is these the two beautiful spaces on the land that Pete has decided to turn into a charity, offering that same peace that he found all those years ago, to people who spend their lives in the service and care of others and who need a chance for respite and recuperation themselves. This grew partially out of Pete's own experience, before and after successful treatment, of being cared for by friends and caring for others. The charity also has five other trustees on the team.<!--
            (?Hyperlink to photo of everyone in case people worry that Pete is just a lunatic..)-->
        </p>
        <p>
            The summer of 2022 will be the first time that Care for Carers goes live, with a trial run to see how things work in practice. Following this we plan to open for applications at various times throughout the year.
        </p>
        <p>
    ...
    <div>
        ...
        <p>
            ...
            Cottages) were built in the Mill Yard, where the remains of these have been incorporated into the Outside House.
        </p>
        <p>
            Before 1877 the original windmill had been demolished and by 1898 the steam mill had also
            ceased to function and was partially demolished. A stable, coach house and garage were built on the site for Wellington House, and there is some evidence that the site was then used as a small-holding, with livestock possibly grazing on the allotments. The Caledonian Cottages were demolished in the 1950's.
        </p>
        <p>
            Apart from the boundary walls there was very little remaining of the original mill when Pete bought the site. <!--(LINK)--> The stable and coach house which are still standing and have been left pretty much untouched during current renovations.
        </p>
        <p>
